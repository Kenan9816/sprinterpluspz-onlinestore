...
import { ShoppingBag, Trash2, Plus, Minus, ArrowRight, CreditCard, ShieldCheck, Truck } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';
import { motion, AnimatePresence } from 'motion/react';
import { cn } from '../lib/utils';

export default function Cart() {
  const { cart, removeFromCart, updateCartQty, clearCart, placeOrder, user, t, getLocalized } = useStore();
          ...
          <div className="bg-white border border-zinc-200 rounded-[32px] p-8 lg:p-10 shadow-2xl shadow-zinc-200/50">
            ...
            <div className="space-y-4 mb-8 text-sm">
              ...
              <div className="flex justify-between text-zinc-500 font-medium">
                ...
                <span className={cn("font-bold", shipping === 0 ? "text-emerald-500" : "text-zinc-900")}>
        ...
        {showCheckout && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-xl bg-white rounded-[40px] shadow-3xl p-8 lg:p-12"
            >
              <h2 className="text-3xl font-black text-zinc-900 mb-8 tracking-tight">{t('secureCheckout')}</h2>
