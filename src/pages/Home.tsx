    ...
    <div className="space-y-0">
      ...
      <section id="brands" className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 border-b border-zinc-100">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8 opacity-40 hover:opacity-100 transition-opacity duration-500">
          ...
          <span className="text-2xl font-bold italic">BOSCH</span>
          <span className="text-2xl font-bold tracking-tight">MANN FILTER</span>
          <span className="text-3xl font-light tracking-widest">brembo</span>
          <span className="text-2xl font-semibold">HELLA</span>
          <span className="text-2xl font-black italic">SACHS</span>
        </div>
      </section>
    </div>
  );
