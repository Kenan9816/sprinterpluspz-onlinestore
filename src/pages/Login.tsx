...
export default function Login() {
  ...
  const { login, loginEmail, register, user, resendVerification, t } = useStore();
          ...
          {mode === 'verify' ? (
            ...
            >
              ...
              <div className="relative py-6">
                ...
                <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest"><span className="bg-white px-4 text-zinc-300">Or continue with</span></div>
              </div>

              <button 
                type="button"
                onClick={() => login()}
                className="w-full h-16 bg-white border-2 border-zinc-100 text-zinc-900 font-black rounded-2xl flex items-center justify-center gap-4 hover:border-zinc-900 transition-all duration-300 active:scale-[0.98]"
              >
